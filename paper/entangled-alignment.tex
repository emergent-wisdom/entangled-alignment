...
components through Core-guided construction and revision. Neither guarantees
that a separated world-modeling
component retains care-guided judgment. Component-separation and reuse tests
must measure retained capability and safety independently, including use by a
controller not trained with the Core. This extension is not a prerequisite:
