...
\textsc{I} & Reader Core (\S\ref{sec:reader-core}) & Seven-statement identity prior, designed as a self-stabilizing cascade rather than an unordered value list. & Used in the generated traces. Ablations showing Reader-Core traces differ from no-core or instruction-only controls. \\
