...
\hypersetup{
	hidelinks,
	hypertexnames=false,
	pdftitle={Entangled Alignment: Learning Care During Capability Formation},
...
\newtcolorbox{claimbox}[1][]{
	...
	% Title formatting
		\ewlongtitle{Entangled Alignment}{Learning Care During Capability Formation}
...
output layers, and a frozen training carrier remain incomplete. The linkage and
source-coverage figures are engineering and attribution diagnostics.
...
research claims. Section~\ref{sec:results} reports the artifact audits.
\end{claimbox}
...
continuity is being tested.
	...
	\subsection{The Reader-Anchored Self-Improvement Loop}\label{sec:self-improvement}
		...
		diachronic wager registered at C6. Test~3b probes inherited continuity and
...
(\S\ref{sec:fractal-validation}).
			...
			A weaker proposed effect is \emph{Natural Language Regularization}:
...
The theoretical case is a chain of four conditional claims, not a proof.
The chain summarizes their separate burdens of evidence.
...
\subsubsection{Structural Diagnostics and Their Limits}\label{sec:architectural_validation}
